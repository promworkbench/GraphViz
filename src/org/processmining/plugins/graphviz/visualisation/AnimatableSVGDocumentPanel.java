 ...
 */
public class AnimatableSVGDocumentPanel extends NavigableSVGDocumentPanel {
	...
	public AnimatableSVGDocumentPanel(SVGDocument image) {
		super(image);
		init();
	}
	...
	private void init() {
		...
		double[] e;
		e = getExtremeTimes(svgDocument.getRootElement());
	...
	public void setImage(SVGDocument image, boolean resetView) {
		...
		//prepare animation timer
		double[] e = getExtremeTimes(image.getRootElement());
		setAnimationExtremeTimes(e[0], e[1]);
	}
...
//		}
	...
	public static double[] getExtremeTimes(SVGSVGElement e) {
